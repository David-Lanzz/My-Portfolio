...
firstBtn.addEventListener('click',function(){
  ...
  secondBtn.addEventListener('click',function(){
    ...
    popupImg.style.backgroundImage = "url('./images/Snapshoot\ Portfolio\ 2.png')"
    popup.style.bottom = '0'
    ...
    thirdBtn.addEventListener('click',function(){
      ...
      popupImg.style.backgroundImage = "url('./images/Snapshoot\ Portfolio\ 3.png');"
      popup.style.bottom = '0'
      ...
      fourthBtn.addEventListener('click',function(){
        ...
        popupImg.style.backgroundImage = "url('./images/Snapshoot Portfolio 4.png');"
        popup.style.bottom = '0'
